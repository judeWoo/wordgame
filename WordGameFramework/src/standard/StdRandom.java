 ...
 *
 *  A library of static methods to generate pseudo-standard numbers from
 ...
 *      strength standard number generator in Java.
 *
 ******************************************************************************/
 ...
 *  standard number from various discrete and continuous distributions,
...
public final class StdRandom {
    ...
    private static Random random;    // pseudo-standard number generator
     ...
     * This method enables you to produce the same sequence of "standard"
    ...
    /**
     * Returns a standard real number uniformly in [0, 1).
     *
     * @return a standard real number uniformly in [0, 1)
     */
    ...
    /**
     * Returns a standard integer uniformly in [0, n).
     *
     * @param n number of possible integers
     * @return a standard integer uniformly between 0 (inclusive) and {@code n} (exclusive)
    ...
    /**
     * Returns a standard integer uniformly in [a, b).
     *
     * @param  a the left endpoint
     * @param  b the right endpoint
     * @return a standard integer uniformly in [a, b)
    ...
    /**
     * Returns a standard real number uniformly in [a, b).
     *
     * @param  a the left endpoint
     * @param  b the right endpoint
     * @return a standard real number uniformly in [a, b)
    ...
    /**
     * Returns a standard boolean from a Bernoulli distribution with success
     * probability <em>p</em>.
     *
    ...
    /**
     * Returns a standard real number from a standard Gaussian distribution.
     *
     * @return a standard real number from a standard Gaussian distribution
    ...
    /**
     * Returns a standard real number from a Gaussian distribution with mean &mu;
    ...
    /**
     * Returns a standard integer from a geometric distribution with success
     * probability <em>p</em>.
     *
     * @param  p the parameter of the geometric distribution
     * @return a standard integer from a geometric distribution with success
    ...
    /**
     * Returns a standard integer from a Poisson distribution with mean &lambda;.
     *
     * @param  lambda the mean of the Poisson distribution
     * @return a standard integer from a Poisson distribution with mean {@code lambda}
    ...
    /**
     * Returns a standard real number from the standard Pareto distribution.
     *
     * @return a standard real number from the standard Pareto distribution
     */
    ...
    /**
     * Returns a standard real number from a Pareto distribution with
     * shape parameter &alpha;.
     *
     * @param  alpha shape parameter
     * @return a standard real number from a Pareto distribution with shape
    ...
    /**
     * Returns a standard real number from the Cauchy distribution.
     *
     * @return a standard real number from the Cauchy distribution.
     */
    ...
    /**
     * Returns a standard integer from the specified discrete distribution.
     *
     * @param  probabilities the probability of occurrence of each integer
     * @return a standard integer from a discrete distribution:
    ...
    /**
     * Returns a standard real number from an exponential distribution
     * with rate &lambda;.
     *
     * @param  lambda the rate of the exponential distribution
     * @return a standard real number from an exponential distribution with
     *         rate {@code lambda}
    ...
    /**
     * Rearranges the elements of the specified array in uniformly standard order.
     *
    ...
    /**
     * Rearranges the elements of the specified subarray in uniformly standard order.
     *
     * @param  a the array to shuffle
